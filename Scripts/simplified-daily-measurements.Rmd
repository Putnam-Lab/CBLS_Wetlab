...
# Save plot 
ggsave("../Output/Daily_Measurements_simplified.pdf", daily_tank, width = 20, height = 15, units = c("in"))
```
...
# Save plot 
ggsave("../Output/Daily_Measurements_Past_Month_simplified.pdf", daily_month, width = 20, height = 15, units = c("in"))
```
