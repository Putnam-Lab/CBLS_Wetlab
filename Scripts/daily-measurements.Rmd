...
month <-daily_measurements[daily_measurements$Date >= "2022-06-01" & daily_measurements$Date <= "2023-01-25", ] # use if you would like to subset by month or from certain date range 
...
pdf(file = "/Users/laurenzane/Desktop/Putnam_Lab/CBLS_Wetlab/Output/20230125_daily_measurements.pdf",
    width = 4,
    height = 4)
