...
month <-daily_measurements[daily_measurements$Date >= "2022-06-01" & daily_measurements$Date <= "2023-05-19", ] # use if you would like to subset by month or from certain date range 
...
write.table(total_pH,"/Users/laurenzane/Desktop/Putnam_Lab/CBLS_Wetlab/Data/total_pH_output.csv",sep=",", row.names=FALSE) 

# read in cumulative total_pH 

cumu.pH <- read.csv("/Users/laurenzane/Desktop/Putnam_Lab/CBLS_Wetlab/Data/total_pH.csv")
...
write.table(update.pH,"/Users/laurenzane/Desktop/Putnam_Lab/CBLS_Wetlab/Data/total_pH.csv",sep=",", row.names=FALSE)
...
pdf(file = "../Output/20230717_dailymeasurements.pdf",
    width = 4,
    height = 4)
