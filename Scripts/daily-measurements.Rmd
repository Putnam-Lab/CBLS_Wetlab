...
month <-daily_measurements[daily_measurements$Date >= "2022-06-01" & daily_measurements$Date <= "2022-08-16", ] # use if you would like to subset by month or from certain date range 
...
month <-daily_measurements[daily_measurements$Date >= "2022-07-25" & daily_measurements$Date <= "2022-08-16", ]
...
write.table(total_pH,"/Users/laurenzane/Desktop/Putnam_Lab/CBLS_Wetlab/Data/20220816_total_pH.csv",sep=",", row.names=FALSE)
...
# create pdf 
pdf(file = "/Users/laurenzane/Desktop/Putnam_Lab/CBLS_Wetlab/Output/20220816_daily_measurements.pdf",
    width = 4,
    height = 4)
