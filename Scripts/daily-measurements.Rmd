...
month <-daily_measurements[daily_measurements$Date >= "2022-06-01" & daily_measurements$Date <= "2022-08-30", ] # use if you would like to subset by month or from certain date range 
...
month <-daily_measurements[daily_measurements$Date >= "2022-08-17" & daily_measurements$Date <= "2022-08-29", ]
...
pdf(file = "/Users/laurenzane/Desktop/Putnam_Lab/CBLS_Wetlab/Output/20220830_daily_measurements.pdf",
    width = 4,
    height = 4)
