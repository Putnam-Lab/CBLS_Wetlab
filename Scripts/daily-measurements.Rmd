...
# Save plot 
ggsave("../Output/Daily_Nutrients.pdf", daily_tank, width = 20, height = 15, units = c("in"))
```
...
# Save plot 
ggsave("../Output/Daily_Nutritents_Past_Month.pdf", daily_month_plot, width = 20, height = 15, units = c("in"))
```
