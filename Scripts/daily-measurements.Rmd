...
```{r}
getwd()
daily <- read.csv("Desktop/Putnam_Lab/CBLS_Wetlab/Data/Daily_measurements_tracking.csv")
...
```{r}
pHcalib<-read_csv("Desktop/Putnam_Lab/CBLS_Wetlab/Data/Tris_Calibration.csv")
...
# Save plot 
ggsave("../Output/Plots/20231114_Daily_Measurements.pdf", daily_tank, width = 20, height = 15, units = c("in"))
```
