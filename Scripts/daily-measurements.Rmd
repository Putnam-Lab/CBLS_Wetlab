...
```{r}
hlines_data <- list(
  data.frame(yintercept = 24, metric = "Temperature_C"), # lower threshold for temperature in C°
  data.frame(yintercept = 27.5, metric = "Temperature_C"), # upper threshold for temperature in C°
