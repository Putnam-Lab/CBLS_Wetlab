...
month <-daily_measurements[daily_measurements$Date >= "2022-06-01" & daily_measurements$Date <= "2022-08-26", ] # use if you would like to subset by month or from certain date range 
...
month <-daily_measurements[daily_measurements$Date >= "2022-08-23" & daily_measurements$Date <= "2022-08-26", ]
...
write.table(total_pH,"/Users/laurenzane/Desktop/Putnam_Lab/CBLS_Wetlab/Data/20220826_total_pH.csv",sep=",", row.names=FALSE)
...
# create pdf 
pdf(file = "/Users/laurenzane/Desktop/Putnam_Lab/CBLS_Wetlab/Output/20220826_daily_measurements.pdf",
    width = 4,
    height = 4)
