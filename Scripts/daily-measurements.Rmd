...
month <-daily_measurements[daily_measurements$Date >= "2022-06-01" & daily_measurements$Date <= "2022-08-25", ] # use if you would like to subset by month or from certain date range 
...
month <-daily_measurements[daily_measurements$Date >= "2022-08-23" & daily_measurements$Date <= "2022-08-25", ]
...
getwd()
total_pH_cumu <- read.csv("/Users/laurenzane/Desktop/Putnam_Lab/CBLS_Wetlab/Data/total_pH.csv")
total_pH_cumu$Date <- format(total_pH_cumu$Date, "%d-%m-%Y")
total_pH_cumu$Date <- as.Date(total_pH_cumu$Date)
update.data <- rbind(total_pH_cumu, total_pH)
tail(update.data)
ymd(update.data$Date)
write.table(total_pH,"/Users/laurenzane/Desktop/Putnam_Lab/CBLS_Wetlab/Data/20220817_total_pH.csv",sep=",", row.names=FALSE)
...
# create pdf 
pdf(file = "/Users/laurenzane/Desktop/Putnam_Lab/CBLS_Wetlab/Output/20220825_daily_measurements.pdf",
    width = 4,
    height = 4)
