...
\NormalTok{month }\OtherTok{\textless{}{-}}\NormalTok{daily\_measurements[daily\_measurements}\SpecialCharTok{$}\NormalTok{Date }\SpecialCharTok{\textgreater{}=} \StringTok{"2022{-}06{-}01"} \SpecialCharTok{\&}\NormalTok{ daily\_measurements}\SpecialCharTok{$}\NormalTok{Date }\SpecialCharTok{\textless{}=} \StringTok{"2023{-}01{-}25"}\NormalTok{, ] }\CommentTok{\# use if you would like to subset by month or from certain date range }
