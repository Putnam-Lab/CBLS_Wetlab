...
\NormalTok{month }\OtherTok{\textless{}{-}}\NormalTok{daily\_measurements[daily\_measurements}\SpecialCharTok{$}\NormalTok{Date }\SpecialCharTok{\textgreater{}=} \StringTok{"2022{-}06{-}01"} \SpecialCharTok{\&}\NormalTok{ daily\_measurements}\SpecialCharTok{$}\NormalTok{Date }\SpecialCharTok{\textless{}=} \StringTok{"2023{-}02{-}08"}\NormalTok{, ] }\CommentTok{\# use if you would like to subset by month or from certain date range }
...
\CommentTok{\# append total pH to cumulative total pH dataframe each week; I may remove this it is unneccesay and confusing and we can just overwrite every time }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{total\_pH\_cumu }\OtherTok{\textless{}{-}} \FunctionTok{read.csv}\NormalTok{(}\StringTok{"/Users/laurenzane/Desktop/Putnam\_Lab/CBLS\_Wetlab/Data/total\_pH.csv"}\NormalTok{) }\CommentTok{\# do not change}
\NormalTok{total\_pH\_cumu}\SpecialCharTok{$}\NormalTok{Date }\OtherTok{\textless{}{-}} \FunctionTok{as.Date}\NormalTok{(total\_pH\_cumu}\SpecialCharTok{$}\NormalTok{Date)}
\NormalTok{total\_pH}\SpecialCharTok{$}\NormalTok{Date }\OtherTok{\textless{}{-}} \FunctionTok{as.Date}\NormalTok{(total\_pH}\SpecialCharTok{$}\NormalTok{Date)}
\NormalTok{update.data }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(total\_pH\_cumu, total\_pH)}
\FunctionTok{tail}\NormalTok{(update.data)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##            Date     Tank_ID Temperature_C    mvTris   phTris pH.Total
## 1291 2023-02-07  blue_tank4         26.40 -58.66978 8.049990       NA
## 1292 2023-02-08 header_tank         26.35 -58.72744 8.051541       NA
## 1293 2023-02-08  blue_tank1         26.32 -58.76204 8.052471       NA
## 1294 2023-02-08  blue_tank2         26.32 -58.76204 8.052471       NA
## 1295 2023-02-08  blue_tank3         26.32 -58.76204 8.052471       NA
## 1296 2023-02-08  blue_tank4         26.32 -58.76204 8.052471       NA
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{view}\NormalTok{(update.data)}
\FunctionTok{view}\NormalTok{(total\_pH)}
\FunctionTok{ymd}\NormalTok{(update.data}\SpecialCharTok{$}\NormalTok{Date)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{daily-measurements_files/figure-latex/unnamed-chunk-7-1.pdf}
